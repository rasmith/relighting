...
class CurvatureDataset(data.Dataset):
    def __init__(self, input_dir, cfg_file, image_dir, curvature_dir, transform = None,\
                 target_transform = None):
        self.cfg_file = cfg_file
        self.input_dir = input_dir 
        self.image_dir = image_dir
        self.curvature_dir = curvature_dir 
    ...
    def __getitem__(self, idx):
        ...
        curvature_file_name = "curvatures-%s-%s.png" % (matches[1], matches[2])
        target_path = "%s/%s" % (self.curvature_dir, curvature_file_name)
