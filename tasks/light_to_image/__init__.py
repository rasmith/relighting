from datasets.light_dataset import LightDataset
import models as r
...
cfg = {
    ...
    'evaluation_enabled': False, # to evaluate this task
...
class CfgLoader(object):
  ...
  def get_cfg(self, device):
    ...
    self.cfg['dataset'] = LightDataset(cfg['input_dir'], cfg['cfg_file'],
