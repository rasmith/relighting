from datasets.camera_dataset import CameraDataset
import models as r
...
class CfgLoader(object):
  ...
  def get_cfg(self, device):
    ...
    self.cfg['dataset'] = CameraDataset(cfg['target_dir'], cfg['task_name'],
                                        cfg['transform'],
